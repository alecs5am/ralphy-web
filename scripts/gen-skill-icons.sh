...
ITEMS=(
"ugc-unboxing|open cardboard delivery box with flaps open"
"ugc-ad|glowing yellow megaphone"
"ugc-model-swap|two overlapping person head silhouettes with circular swap arrows"
"ugc-rockstar|gold five-pointed star badge with a tiny palm tree"
"researcher|magnifying glass"
"evaluator|white clipboard with a checkmark and a star rating"
"install|downward download arrow dropping into an open tray"
"postmortem|open notebook with a wooden pencil"
"templater|stack of three layered blueprint cards"
"audio-explainer|blue headphones with an orange sound waveform"
"dev-release|launching rocket with an orange flame"
