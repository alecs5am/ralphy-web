    ...
    <svg viewBox="185 223 1591 1591" className={className} style={style} aria-label={ariaLabel}>
      <defs>
        <mask
          ...
          height="1591"
        >
          <rect x="185" y="223" width="1591" height="1591" fill="#fff" />
          <g className="logo-eyes-look">
            <g className="logo-eye-blink">
              <path
                transform="translate(899,973)"
                d="m0 0h13l16 5 9 7 9 10 8 13 4 8 7 28 1 10v28l-2 21-6 24-7 16-6 10-8 10-8 7-12 6-10 3h-8l-16-4-8-4-5-4v-2l-4-2-9-12-7-15-4-12-4-24v-41l5-27 6-18 8-14 11-12 9-8 8-4z"
                fill="#000"
              />
            </g>
            <g className="logo-eye-blink">
              <path
                transform="translate(679,967)"
                d="m0 0 13 1 13 4 11 7 10 12 6 10 7 16 4 15 3 20v24l-4 27-5 20-8 16-7 9-7 8-10 7-10 4-5 1h-16l-13-4-11-8-9-10-8-14-7-24-2-10-1-11v-26l2-19 5-23 7-17 7-11 9-10 10-8 12-5z"
                fill="#000"
              />
            </g>
          </g>
...
export function LogoGlyph({ size = 28 }: { size?: number }) {
  return (
    <MascotSVG className="logo-glyph" style={{ width: size, height: size, display: "block" }} />
  );
}
