...
description: >-
  ...
  TRIGGER (RU): "сгенерируй промпты / ассеты", "сделай картинки / видео / VO / музыку", "перегенерь scene-XX", "попробуй другую модель", "поменяй kling на veo", "сделай 2-3 варианта", "A/B вариант хука", "сколько будет стоить N видео".
  ALSO FIRE if scenario is locked AND user says "ok, поехали" / "let's go" / "запускай" while asset-manifest is incomplete.
