...
description: >-
  ...
  This is a niche SKILL (generalized), not a remix TEMPLATE (one specific poster). For "remix this exact poster but swap X", that is the remix path in docs/skills-vs-templates.md. For a moving video, use the video niche skills (ralphy-ugc-*).
---
...
- The user wants a moving video (the wordmark animates, the hero talks) → that is a video niche skill (`ralphy-ugc-*`) + the editor playbook, not this skill.
