<!--
  ...
  Source: https://github.com/Alisa0808/vox-director  (references/beat-layer.md)
  Licensed MIT — Copyright (c) 2026 Atlas Cloud. See vox-collage/SKILL.md "Attribution & license".

  This is the pure STORY-layer methodology (narrative arcs, pacing, shot/camera vocabulary) —
  reproduced unchanged, model-agnostic. In THIS repo, execution routes ONLY through ralphy verbs
  (see SKILL.md). Where this doc names the original's scripts or Atlas model ids, read the
  SKILL.md model-mapping table for the ralphy equivalent. The arcs, hook patterns, beat counts,
  and flat-safe camera-move vocabulary below are what you actually use.
-->
