...
- The user wants a still poster of the same vibe → use [`/ralphy-poster`](../ralphy-poster/SKILL.md) with an analog-horror aesthetic.
...
12. **Hand off** to `/ralphy-evaluator` for the post-render quality gate.
