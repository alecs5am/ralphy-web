...
description: >-
  ...
  This is a niche SKILL (generalized), not a remix TEMPLATE. For "remix this exact carousel but swap X", use the remix path in docs/skills-vs-templates.md. For a single still, use /ralphy-poster.
---
...
**DO NOT FIRE** when:
- The brief is for ONE still (poster, drop graphic) → use [`/ralphy-poster`](../ralphy-poster/SKILL.md) instead.
- The brief is for N static ads across registers (FB / Meta ad pack) → use [`/ralphy-fb-creatives`](../ralphy-fb-creatives/SKILL.md) instead.
