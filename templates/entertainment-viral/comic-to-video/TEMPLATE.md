...
- **The user wants "a comic-style original story from a brief."** That's `talking-character` or `cinematic` with comic-style keyframes — not this template, which is conversion-only.
