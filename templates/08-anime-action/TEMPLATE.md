...
**Slug:** `08-anime-action` · **Aspect:** 9:16 · **fps:** 24 (anime standard) · **Duration:** 6–15 s · **Clips:** 2–4 · **Reference:** optional (required only for named characters / real franchises).
...
- The user wants 3D-CGI realism — use `02-3d-cgi`.
- The user wants Western cartoon (rounder shapes, softer edges, pastel) — use `03-cartoon`.
- The user wants live-action martial arts choreography without stylization — use `05-fight-scenes`.
- The user wants comic-panel-to-video (Western superhero) — use `04-comic-to-video`.
