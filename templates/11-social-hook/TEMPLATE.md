...
Don't use it for:
- Anything that needs a full narrative arc (use `talking-head-rant`, `before-after-product`, or `06-motion-design-ad`).
...
- The user wants a music video (use 10-music-video).
- The user wants something cinematic / slow / mood-driven (use 01-cinematic). Hooks are loud and fast by definition.
