...
//
// Presentation-only (no "use client", no server-only APIs): everything here is
// selectable / downloadable text. It is rendered INSIDE the BlueprintModal
// (#079) rather than dumped inline on the page — the unit page now leads with the
// viewer + similar-units rail (Pinterest browse), and the Blueprint lives behind
...
/** The blueprint cost rendered as a formatted USD string, for the modal header.
 *  Exported so the modal can show "Total cost to reproduce" near the title. */
export function blueprintCost(blueprint?: Blueprint): string | undefined {
